...
| **Mobile PWA & CLI sync** | Home Screen install on iOS/Android with push and voice; e-ink display mode; two-way CLI sync — web sessions resume from a terminal via `tmux attach -t xy-<id>`. |
