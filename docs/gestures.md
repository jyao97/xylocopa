...
The touch shortcuts behind Xylocopa's UI. Everything here also works with a mouse (long-press = click-and-hold).

- Short-press **+** to add a task; long-press to create a project.
...
- In e-ink display mode, a two-finger swipe page-scrolls (designed for e-paper readers).
