...
export default function MissingFileCard({ filename, originalPath, dark = false }) {
  if (dark) {
    return (
      <div
        className="inline-flex items-center gap-2 px-4 py-3 rounded-lg bg-black/60 max-w-[80vw]"
