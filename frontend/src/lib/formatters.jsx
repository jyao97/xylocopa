...
const DOC_EXTS = /\.(py|js|ts|jsx|tsx|html|css|md|txt|pdf|xlsx|xls|docx|doc|pptx|ppt|sh|bash|rb|go|rs|c|cpp|h|hpp|java|kt|swift|yaml|yml|toml|xml|sql|r|lua|pl|ex|exs|zig|nim|dart|scala|clj|hs|erl|elm)$/i;
const CSV_EXTS = /\.(csv)$/i;
const IGNORE_EXTS = /\.(jsonl|log|json|lock)$/i;

// All extensions the agent path scanner should match (media + doc)
const AGENT_EXTS = /\.(png|jpg|jpeg|gif|svg|webp|mp4|webm|mov|csv|py|js|ts|jsx|tsx|html|css|md|txt|pdf|xlsx|xls|docx|doc|pptx|ppt|sh|bash|rb|go|rs|c|cpp|h|hpp|java|kt|swift|yaml|yml|toml|xml|sql|r|lua|pl|ex|exs|zig|nim|dart|scala|clj|hs|erl|elm|ply|obj|stl|glb|gltf)$/i;

// Compiled regexes for agent path detection
const AGENT_EXT_LIST = "png|jpg|jpeg|gif|svg|webp|mp4|webm|mov|csv|py|js|ts|jsx|tsx|html|css|md|txt|pdf|xlsx|xls|docx|doc|pptx|ppt|sh|bash|rb|go|rs|c|cpp|h|hpp|java|kt|swift|yaml|yml|toml|xml|sql|r|lua|pl|ex|exs|zig|nim|dart|scala|clj|hs|erl|elm|ply|obj|stl|glb|gltf";
