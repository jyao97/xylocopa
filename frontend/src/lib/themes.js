...
export const PRESETS = [
  ...
  { id: "soft-light", name: "Soft Light", base: "light",
    preview: { page: "#f4f4f5", surface: "#ebebed", text: "#323236" },
    core: { page: "#f4f4f5", surface: "#ebebed", heading: "#323236", body: "#515156", edge: "#d1d1d6", bubble: "#2b7a9b" } },
  ...
  { id: "nord-light", name: "Nord Light", base: "light",
    preview: { page: "#eceff4", surface: "#e5e9f0", text: "#2e3440" },
    core: { page: "#eceff4", surface: "#e5e9f0", heading: "#2e3440", body: "#434c5e", edge: "#c2cbd8", bubble: "#527099" } },
...
const TERMINAL_THEMES = {
  ...
  "soft-light": {
    background: "#f4f4f5", foreground: "#515156", cursor: "#2b7a9b",
    cursorAccent: "#f4f4f5", selectionBackground: "#d8d8dc",
    ...GITHUB_LIGHT_ANSI,
  },
  // Snow Storm ground, Polar Night ink, nord's own accent set.
  "nord-light": {
    background: "#eceff4", foreground: "#2e3440", cursor: "#2e3440",
    cursorAccent: "#eceff4", selectionBackground: "#d8dee9",
